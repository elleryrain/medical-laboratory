...
export const getGetStorageInfoResponseMock = (): StorageItem[] =>
  Array.from(
    ...
    complectCount: faker.helpers.arrayElement([
      faker.number.int({ min: undefined, max: undefined }),
      undefined,
    ]),
    freeCount: faker.helpers.arrayElement([
      faker.number.int({ min: undefined, max: undefined }),
      undefined,
    ]),
    fullCount: faker.helpers.arrayElement([
      faker.number.int({ min: undefined, max: undefined }),
      undefined,
    ]),
    usedCount: faker.helpers.arrayElement([
      faker.number.int({ min: undefined, max: undefined }),
      undefined,
    ]),
  }));
...
export const getGetStorageInfoMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<StorageItem[]> | StorageItem[]),
) => {
  return http.get('*/api/storage', async (info) => {
    await delay(1000);
