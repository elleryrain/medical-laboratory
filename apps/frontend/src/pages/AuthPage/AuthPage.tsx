        ...
        <div className="flex justify-center items-center text-white">
            ...
            <div className="flex flex-col gap-[70px] w-[600px] mt-[18.5vh]">
                ...
                <form className="flex flex-col gap-5" action="">
                    ...
                    <p className="cursor-pointer text-right text-[20px] font-medium">Забыли пароль?</p>
                    <button
                        className="cursor-pointer bg-white text-black rounded-[15px] h-[71px] text-[24px] 
                        font-medium hover:bg-[#BDFF67] transition duration-500"
                        type="submit"
                    >
                        Вход
                    </button>
