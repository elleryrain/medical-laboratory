    ...
    return (
        <div className="bg-[#1C1C1C] w-[815px] px-[35px] pt-[35px] pb-[30px] rounded-[45px]">
            ...
            <div className="flex justify-between gap-[140px] items-center">
                <p className="text-5xl font-medium text-nowrap">{formatNumber(fixedSalary + bonuses - penalties)} ₽</p>
                <SalaryChart fixedSalary={fixedSalary} bonuses={bonuses} penalties={penalties} />
            </div>
            ...
            <div className="flex flex-wrap gap-2.5">
                ...
                <div className="flex bg-[#2D2D2D] justify-between items-center pl-0.5 pr-3 py-0.5 rounded-full gap-2">
                    ...
                    <p className="font-medium text-[20px] text-nowrap">{formatNumber(penalties)} ₽</p>
                </div>
            </div>
