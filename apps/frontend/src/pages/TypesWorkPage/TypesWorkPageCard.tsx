  ...
  return (
    <>
      {typesWork.map((work) => {
        ...
        const stages = typesWorkStages.filter(
          (stage) => stage.typeWorkId === work.id,
        );
              ...
              <>
                ...
                <TableContainer>
                      ...
                      <NameTypeWorkStage key={stage.id}>
                        ...
                        <StagePriceContainer>
                          {stage.nameMaterial === 'Нет' ? (
                            ...
                            <StageNameMaterial>
                              {stage.nameMaterial}, {stage.pricePiece} ₽/
                              {stage.namePiece}
                            </StageNameMaterial>
                          )}
                          <StagePriceMaterial>
                  ...
                  <TotalPriceNameContainer>
                    ...
                    <TotalPriceContainer>
                      <TotalPricePieceMaterial>
                        {stages.reduce(
                          (acc, stage) => acc + stage.pricePiece,
                          0,
                        )}{' '}
                        ₽
                      </TotalPricePieceMaterial>
                      <TotalPriceMaterial>
                        {stages.reduce(
                          (acc, stage) => acc + stage.priceMaterial,
                          0,
                        )}{' '}
                        ₽
                      </TotalPriceMaterial>
                      <TotalPrice>
                        {stages.reduce(
                          (acc, stage) => acc + stage.totalPrice,
                          0,
                        )}{' '}
                        ₽
                      </TotalPrice>
